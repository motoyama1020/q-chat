...
## 機能一覧
- ユーザーログイン機能→deviseの導入
- ユーザー情報編集機能(onオプション)→イベント参加回数、クリア回数、成功率の出力
- チャットルーム作成機能→ActiveHashの導入
- メッセージ＆画像投稿機能→ActiveStrage,AWS(S3)の導入
- チャットルーム検索機能→ransackの導入
- ユーザーアイコン表示
- ゲストログイン機能
